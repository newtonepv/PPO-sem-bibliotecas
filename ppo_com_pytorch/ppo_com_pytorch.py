...
for i in range(1,config.num_atualizacoes+1):
    ...
    # Replace the existing learning rate line with:
    fracao = 1.0 - (i - 1.0) / config.num_atualizacoes
    otimizador.param_groups[0]['lr'] = config.vel_aprendizado * config.num_ambientes * fracao
